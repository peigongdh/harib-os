...
haribote.img : haribote/ipl10.bin haribote/haribote.sys Makefile \
		...
		star1/star1.hrb stars/stars.hrb stars2/stars2.hrb typeipl/typeipl.hrb\
		lines/lines.hrb walk/walk.hrb noodle/noodle.hrb \
		beepdown/beepdown.hrb color/color.hrb color2/color2.hrb\
		cat/cat.hrb nihao/nihao.hrb
	$(EDIMG)   imgin:../z_tools/fdimg0at.tek \
		...
		copy from:nihao/nihao.hrb to:@: \
		copy from:font/HZK.fnt to:@: \
		imgout:haribote.img
